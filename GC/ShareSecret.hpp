...
#include "Protocols/MultiReplicatedMC.hpp"
...
template<class U>
BitVec ReplicatedSecret<U>::local_mul_0(const ReplicatedSecret& other) const
{
    return (*this)[0] * other[1] + (*this)[1] * other[0] + (*this)[1] * other[1];
}

template<class U>
BitVec ReplicatedSecret<U>::local_mul_1(const ReplicatedSecret& other) const
{
    return (*this)[0] * other[1] + (*this)[1] * other[0];
}

template<class U>
BitVec ReplicatedSecret<U>::local_mul_2(const ReplicatedSecret& other) const
{
